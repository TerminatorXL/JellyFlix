...
/*! Generated from addons/ (11 modules, 1 stylesheets). Build f74467578a3c.
 ...
 *
 * `f74467578a3c` is a content hash of this exact bundle, stamped in by build-addon.mjs. That turns the
    ...
    if (running.bundle === 'pause-info-card') {
        ...
        if (typeof running.stop !== 'function') {
            console.warn('[JellyFlix] another build of "pause-info-card" is running and cannot be stopped;'
                + ' this copy (f74467578a3c) stands down. Remove one of the two installs.');
            return;
        }
        console.warn('[JellyFlix] replacing build', running.build, 'with f74467578a3c');
        try {
            running.stop();
        } catch (err) {

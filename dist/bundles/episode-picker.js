...
/*! Generated from addons/ (8 modules, 1 stylesheets). Build 038184cc9e17.
 ...
 *
 * `038184cc9e17` is a content hash of this exact bundle, stamped in by build-addon.mjs. That turns the
    ...
    if (running.bundle === 'episode-picker') {
        ...
        if (typeof running.stop !== 'function') {
            console.warn('[JellyFlix] another build of "episode-picker" is running and cannot be stopped;'
                + ' this copy (038184cc9e17) stands down. Remove one of the two installs.');
            return;
        }
        console.warn('[JellyFlix] replacing build', running.build, 'with 038184cc9e17');
        try {
            running.stop();
        } catch (err) {
